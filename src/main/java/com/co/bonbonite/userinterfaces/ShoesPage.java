...
public class ShoesPage {
    ...
    public static final Target OP_TALLA=Target.the("t USER").locatedBy("//select[@id=\"pa_talla\"]");
    ...
    //------------------------------------------------------------------------------------------------------------------------------------------------
    public static  final Target A_AGREGATE_LIST =Target.the("opcion para agregar productos alista de favoritos").locatedBy("//a[@role=button]");
