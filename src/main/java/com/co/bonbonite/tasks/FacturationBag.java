...
public class FacturationBag implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Enter.theValue(facturation.getNombres()).into(Fact_Bag.TXT_NOMBRE));
        actor.attemptsTo(Enter.theValue(facturation.getApellidos()).into(Fact_Bag.TXT_APELLIDOS));
        ...
        actor.attemptsTo(Enter.theValue(facturation.getTELEFONO()).into(Fact_Bag.TXT_TELEFONO));
        actor.attemptsTo(Enter.theValue(facturation.getDIRECCION()).into(Fact_Bag.TXT_DIRECCION));
        actor.attemptsTo(Enter.theValue(facturation.getCODIGO_POSTAL()).into(Fact_Bag.TXT_CODE_ZIP));
    }
